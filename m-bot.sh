...
data_ip="https://raw.githubusercontent.com/amahman/izinvps/main/client/"
checking_sc() {
...
cd /usr/bin
clear
wget https://raw.githubusercontent.com/amahman/sc/main/bot/bot.zip
unzip bot.zip
mv bot/* /usr/bin
chmod +x /usr/bin/*
rm -rf bot.zip
clear
wget https://raw.githubusercontent.com/amahman/sc/main/bot/kyt.zip
unzip kyt.zip
